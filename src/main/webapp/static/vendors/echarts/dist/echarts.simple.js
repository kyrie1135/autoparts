...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    function makeKeyInfo(mainType, mapResult) {
	        ...
	        // in echarts. id can be specified by login, or auto generated.
	    ...
	    function filterBySubType(components, condition) {
	        ...
	        // subType is undefined in login payload.
	    ...
	    layout.mergeLayoutParam = function (targetOption, newOption, opt) {
	        ...
	        function merge(names) {
	            ...
	            each(names, function (name) {
	                ...
	                // set by login for removing width setting.
	            ...
	            // Case: newOption: {width: ..., right: ...},
	            // Than we can make sure login only want those two, and ignore
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     * Then login do some interaction like dataZoom, dataView changing.
	     * `chart.setOption(opt2);`
	     * Then login press 'reset button' in toolbox.
	     *
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    // The rule should not be complex, otherwise login might not
	 ...
	 */
	    ...
	    var IntervalScale = Scale.extend({
	        ...
	        setInterval: function (interval) {
	            ...
	            // Dropped auto calculated niceExtent and use login setted extent
	            // We assume login wan't to set both interval, min, max to get a better result
	    ...
	    var builders = {
	        ...
	        axisLabel: function () {
	            ...
	            if (axis.type !== 'category') {
	                // If min or max are login set, we need to check
