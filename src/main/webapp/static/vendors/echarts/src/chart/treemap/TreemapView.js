 define(function(require) {
                ...
                each(store, function (el, rawIndex) {
                    ...
                    if (reRoot && reRoot.direction === 'drillDown') {
                        ...
                        if (!parent.__tmWillDelete) {
                            ...
                            // which is appropriate for login understanding.
    ...
    function renderNode(
        ...
        function setText(text, style, nodeModel, labelPath, visualColor, contentWidth, contentHeight) {
            ...
            // because in most cases the two attributes are not exposed to login,
            // except in treemap.
        ...
        function prepareAnimationWhenNoOld(lasts, element, storageName) {
            ...
            // Fade in, login can be aware that these nodes are new.
