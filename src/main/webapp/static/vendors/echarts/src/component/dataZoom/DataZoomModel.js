    ...
    var DataZoomModel = echarts.extendComponentModel({
        ...
        defaultOption: {
            ...
            filterMode: 'filter',   // Possible values: 'filter' or 'empty'.
                                    ...
                                    //          This option is applicable when login should not neglect
        ...
        _judgeAutoMode: function () {
            ...
            // The following is login's reponsibility. So using merged
            // option is OK.
            var thisOption = this.option;

            var hasIndexSpecified = false;
            eachAxisDim(function (dimNames) {
                // When login set axisIndex as a empty array, we think that login specify axisIndex
