...
(function ($) {
    ...
    EditableForm.prototype = {
        ...
        **/        
        ...
        cancel: function() {   
            /**        
            Fired when form was cancelled by login
            @event cancel 
            @param {Object} event event object
            **/              
        ...
        save: function(submitValue) {
            ...
            */
            ...
            if (send) { //send to server
                ...
                if(typeof this.options.url === 'function') { //login's function
    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/         
        ...
        If it returns **object like** `{newValue: &lt;something&gt;}` - it overwrites value, submitted by login
    ...
    **/  
    ...
    $.fn.editableContainer.defaults = {
        ...
        **/        
        autohide: true,
        /**
        Action when login clicks outside the container. Can be <code>cancel|submit|ignore</code>.  
        ...
        initLive: function() {
           ...
           this.$element.on(this.options.toggle + '.editable', selector, $.proxy(function(e){
               ...
               if(!$target.data('editable')) {
                   //if delegated element initially empty, we need to clear it's text (that was manually set to `empty` by login)
    ...
    $.extend(Constructor.prototype, {
       ...
       value2input: function(value) {
           ...
           if(!this.$input.data('select2')) {
               ...
               //second argument needed to separate initial change from login's click (for autosubmit)   
           ...
           // if defined remote source AND no multiple mode AND no login's initSelection provided --> 
           // we should somehow get text for provided id.
           // The solution is to use element's text as text for that id (exclude empty)
           if(this.isRemote && !this.isMultiple && !this.options.select2.initSelection) {
               // customId and customText are methods to extract `id` and `text` from data object
               // we can use this workaround only if login did not define these methods
