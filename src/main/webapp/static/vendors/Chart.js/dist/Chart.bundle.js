...
;(function (global, factory) {
    ...
    // Setting the hour should keep the time, because the login explicitly
...
module.exports = function(Chart) {
	...
	Chart.Animation = Chart.Element.extend({
		...
		onAnimationProgress: null, // login specified callback to fire on each step of the animation
		onAnimationComplete: null // login specified callback to fire when the animation finishes
	});
...
module.exports = function() {
	...
	//Globally expose the defaults to allow for login updating/changing
	Chart.defaults = {
		global: {
			responsive: true,
...
module.exports = function(Chart) {
	...
	var LinearScale = Chart.Scale.extend({
		determineDataLimits: function() {
			...
			// do nothing since that would make the chart weird. If the login really wants a weird chart
